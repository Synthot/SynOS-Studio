...
# of depending on synos-fluent-gtk-theme.
set -euo pipefail
...
FLUENT_GTK_COMMIT="7a49a464b0188c340101c52965c18190b1c694cf"
OUT_DIR="$SCRIPT_DIR/deploy/fluent-gnome-shell"

rm -rf "$OUT_DIR" /tmp/Fluent-gtk-theme-gdm
fetch_git_commit https://github.com/vinceliuice/Fluent-gtk-theme.git "$FLUENT_GTK_COMMIT" /tmp/Fluent-gtk-theme-gdm
